...
void CSGD_Direct3D::SetBlend(void)
{
	//m_lpDirect3DDevice->SetRenderState( D3DBLENDOP_SUBTRACT/*D3DRS_ALPHABLENDENABLE*/, TRUE );
}
...
///////////////////////////////////////////////////////////////////
void CSGD_Direct3D::DrawText(TCHAR *lpzText, int nX, int nY, unsigned char ucRed, unsigned char ucGreen, unsigned char ucBlue)
{
